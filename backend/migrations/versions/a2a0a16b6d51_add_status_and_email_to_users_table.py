...
def upgrade():
    ...
    user_statuses = postgresql.ENUM(
        "Invited", "Active", "Deactivated", name="user_statuses"
    )
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column(
                "user_status",
                sa.Enum("Invited", "Active", "Deactivated", name="user_statuses"),
                nullable=False,
            )
        )
        batch_op.add_column(sa.Column("email", sa.String(), nullable=False))
        batch_op.alter_column("auth_id", existing_type=sa.VARCHAR(), nullable=True)
...
def downgrade():
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        batch_op.alter_column("auth_id", existing_type=sa.VARCHAR(), nullable=False)
